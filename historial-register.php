...
<head>
  ...
  <link rel="apple-touch-icon" href="assets/images/logoevet.png">
  <meta name="apple-mobile-web-app-title" content="Flatkit">
  <!-- for Chrome on Android, multi-resolution icon of 196x196 -->
  <meta name="mobile-web-app-capable" content="yes">
  <link rel="shortcut icon" sizes="196x196" href="assets/images/logoevet.png">
      ...
      <div class="left navside dark dk" data-layout="column">
        <div class="navbar no-radius">
          ...
          <a class="navbar-brand">
            ...
            <img src="assets/images/logoevet.png" alt="." class="hide">
            <span class="hidden-folded inline">Jaula UCI EVET</span>
          </a>
          <!-- / brand -->
        </div>
        <div class="hide-scroll" data-flex>
          <nav class="scroll nav-light">
            ...
            <ul class="nav" ui-nav>
              ...
              <li>
                <a href="historial-list.php" >
                  <span class="nav-icon">
                    <i class="fa fa-cogs"></i>
                  </span>
                  <span class="nav-text">Lista de Historial</span>
                </a>
              </li>

              <li>
                <a href="historial-register.php" >
                  <span class="nav-icon">
                    <i class="fa fa-cogs"></i>
                  </span>
                  <span class="nav-text">Registro de Historial</span>
                </a>
              </li>
          ...
          <div class="nav-fold">
            <a href="profile.html">
              <span class="pull-left">
                <img src="assets/images/fotoperfil.jpg" alt="..." class="w-40 img-circle">
              </span>
              <span class="clear hidden-folded p-x">
                <span class="block _500">Franco Rengel</span>
